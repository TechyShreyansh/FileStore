...
async def shortner_panel(client, query_or_message):
    ...
    short_url = getattr(client, 'short_url', SHORT_URL)
    short_api = getattr(client, 'short_api', SHORT_API)
    tutorial_link = getattr(client, 'tutorial_link', "https://t.me/howtodownloadstutorials/5")
    shortner_enabled = getattr(client, 'shortner_enabled', True)
...
<blockquote>**≡ ᴜꜱᴇ ᴛʜᴇ ʙᴜᴛᴛᴏɴꜱ ʙᴇʟᴏᴡ ᴛᴏ ᴄᴏɴꜰɪɢᴜʀᴇ ʏᴏᴜʀ ꜱʜᴏʀᴛɴᴇʀ ꜱᴇᴛᴛɪɴɢꜱ!**</blockquote>"""
    ...
    image_url = MESSAGES.get("SHORT", "https://i.ibb.co/84T9GW8y/Uploaded-6910445402.jpg")
...
**ꜰᴏʀᴍᴀᴛ:** `ᴜʀʟ ᴀᴘɪ`
**ᴇxᴀᴍᴘʟᴇ:** `gplinks.com 9435894656863495834957348`"""
...
async def set_tutorial_link(client: Client, query: CallbackQuery):
    ...
    current_tutorial = getattr(client, 'tutorial_link', "https://t.me/howtodownloadstutorials/5")
...
**ᴇxᴀᴍᴘʟᴇ:** `https://t.me/howtodownloadstutorials/5`"""
