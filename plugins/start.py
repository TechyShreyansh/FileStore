# Don't Remove Credit @TS_Mods1, @MrGhostsx
# Ask Doubt on telegram @Tech_Shreyansh1
#
# Copyright (C) 2025 by TechyShreyansh@Github, < https://github.com/TechyShreyansh >.
#
# This file is part of < https://github.com/TechyShreyansh/FileStore > project,
# and is released under the MIT License.
# Please see < https://github.com/TechyShreyansh/FileStore/blob/master/LICENSE >
#
# All rights reserved.
#
    ...
    if id in ADMINS:
        ...
        if TOKEN:
            ...
            if not verify_status['is_verified']:
                token = ''.join(random.choices(mrghost.ascii_letters + mrghost.digits, k=10))
    ...
    if len(text) > 7:
        ...
        for msg in messages:
            ...
            try:
                ...
                shreyansh_msgs.append(copied_msg)
