...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        if FILE_AUTO_DELETE > 0:
            ...
            asyncio.create_task(
                schedule_auto_delete(client, mrghostsx_msgs, notification_msg, FILE_AUTO_DELETE, reload_url)
            )
    else:
        reply_markup = InlineKeyboardMarkup(
            [
                    [InlineKeyboardButton("• ᴍᴏʀᴇ ᴄʜᴀɴɴᴇʟs •", url="https://t.me/AboutsShreyansh")],
...
async def schedule_auto_delete(client, mrghostsx_msgs, notification_msg, file_auto_delete, reload_url):
